...
</p><asp:TextBox ID="Txtinsta" runat="server" style="top: 234px; left: 367px; position: absolute; height: 22px; width: 128px"></asp:TextBox><asp:TextBox ID="TxtTwi" runat="server" style="top: 276px; left: 368px; position: absolute; height: 22px; width: 128px"></asp:TextBox><p><asp:Button ID="btnSiguiente" runat="server" style="top: 55px; left: 531px; position: absolute; height: 36px; width: 95px" Text="Guardar" OnClick="btnSiguiente_Click" /></p>
        <asp:Button ID="BtnCorreo" runat="server" Text="Agregar Correo" OnClick="BtnCorreo_Click" style="top: 107px; left: 533px; position: absolute; height: 38px; width: 101px" />
<p>
<asp:Button ID="btnTelefono" runat="server" Text="Agregar Telefono" OnClick="btnTelefono_Click" style="top: 202px; left: 539px; position: absolute; height: 39px; width: 102px" />
        </p>
<p>
    <asp:Button ID="btnModificar" runat="server" OnClick="btnModificar_Click" Text="Modificar" style="top: 256px; left: 540px; position: absolute; height: 35px; width: 100px" />
</p>
<p>
    <asp:Button ID="btnEliminar" runat="server" OnClick="btnEliminar_Click" style="top: 157px; left: 537px; position: absolute; height: 36px; width: 102px" Text="Eliminar" />
</p>
</form>
</body>
</html>
