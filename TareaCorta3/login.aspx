...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            <asp:Label ID="lblNombreUs" runat="server" style="top: 78px; left: 307px; position: absolute; height: 19px; width: 106px" Text="lblNombreUsuario"></asp:Label>
        </p>
        ...
        <asp:Button ID="btnRegistrarUsu" runat="server" style="top: 216px; left: 352px; position: absolute; height: 26px; width: 75px" Text="Registrar" />
        <asp:Button ID="btnIngresarUsu" runat="server" style="top: 215px; left: 547px; position: absolute; height: 26px; width: 56px" Text="Ingresar" OnClick="btnIngresarUsu_Click" />
    </form>
</body>
</html>
